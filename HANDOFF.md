...
- `rutinas-espartaco/index.html` — versión autocontenida y ejecutable de toda la app (recomendada para testear el comportamiento sin leer código).
